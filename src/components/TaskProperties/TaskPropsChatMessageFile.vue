  ...
  <div>
    ...
    <div class="w-full inline-block">
      ...
      >
        ...
        <div
          v-if="time && size"
          class="group flex justify-between text-[11px] text-[#7E7E80] font-bold dark:text-gray-300"
        >
          <p>{{ size }}</p>
          <div
            class="flex flex-row-reverse pr-2 pb-1.5 text-[12px] font-normal leading-[16px] text-[#a8afca] dark:text-gray-300"
          >
            <PopMenu
              placement="auto"
