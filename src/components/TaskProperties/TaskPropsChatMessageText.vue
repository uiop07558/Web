<template>
  <div>
    ...
    <div class="w-full inline-block min-h-[40px]">
      <div
        class="group min-w-[40%] max-w-[80%] min-h-[40px] flex flex-col"
      ...
      >
        <div
          ...
          :class="{ 'rounded-tr-[14px]': !isMyMessage, 'rounded-tl-[14px]': isMyMessage }"
        >
          <svg
            width="14"
            height="11"
              ...
              <Transition>
                ...
                >
                  <div class="hidden group-hover:block pl-0 cursor-pointer">
                    <svg class="h-[14px]" width="14" height="4" viewBox="0 0 14 4" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M10.2004 2.0001C10.2004 1.11644 10.9167 0.400098 11.8004 0.400098C12.684 0.400098 13.4004 1.11644 13.4004 2.0001C13.4004 2.88375 12.684 3.6001 11.8004 3.6001C10.9167 3.6001 10.2004 2.88375 10.2004 2.0001Z" fill="black" fill-opacity="0.5"/>
                      <path d="M5.40039 2.0001C5.40039 1.11644 6.11673 0.400098 7.00039 0.400098C7.88405 0.400098 8.60039 1.11644 8.60039 2.0001C8.60039 2.88375 7.88405 3.6001 7.00039 3.6001C6.11673 3.6001 5.40039 2.88375 5.40039 2.0001Z" fill="black" fill-opacity="0.5"/>
                      <path d="M0.60039 2.0001C0.60039 1.11644 1.31674 0.400098 2.20039 0.400098C3.08405 0.400098 3.80039 1.11644 3.80039 2.0001C3.80039 2.88375 3.08405 3.6001 2.20039 3.6001C1.31674 3.6001 0.60039 2.88375 0.60039 2.0001Z" fill="black" fill-opacity="0.5"/>
                    </svg>
                  </div>
                  <template #menu>
