...
<<<<<<< HEAD
  if (user.value.tarif !== 'alpha' && user.value.tarif !== 'trial' && tabName === 'karma') {
    showFreeModal.value = true
    return
  }
=======
>>>>>>> 2446e0964a906ea5dd04306a2f402d9bac8292fc
    ...
    <fieldset class="flex h-full">
      ...
      >
        ...
        <div>
          ...
          <div
            class="px-2 py-2 flex text-center rounded-[9px] hover:bg-white"
            :class="{'bg-white':currentTab==='import'}"
            @click="changeSettingsTab('import')"
          >
            <svg
              width="30"
              height="30"
